...
plot 'tmp/hotels_right.csv' using 12:18 title 'clean_vs_overall' with points
f(x)=m*x+b
fit f(x) 'tmp/hotels_right.csv' using 12:18 via m,b
set output 'c_vs_o.png' 
plot 'tmp/hotels_right.csv' using 12:18 title 'cleaafsf' with points, f(x) title 'fit'
EOF